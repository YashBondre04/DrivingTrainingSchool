...
const BorderGlow = ({
  ...
  }, [autoPlay, autoPlayInterval, triggerSweep]);

  const colorSensitivity = edgeSensitivity + 20;
  const isVisible = isHovered || sweepActive;
  // alwaysGlowOnHover: force proximity=1 on any hover (needed for small elements like buttons)
  const effectiveProximity = alwaysGlowOnHover && isHovered ? 1 : edgeProximity;
